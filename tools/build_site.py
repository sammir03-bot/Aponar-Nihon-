...
I18N_CSS = '<link rel="stylesheet" href="/assets/css/i18n.css?v=20260909.3">'
HOME_BRAND_CSS = '<link rel="stylesheet" href="/assets/css/home-brand.css?v=20260901.2">'
I18N_JS = '<script src="/assets/js/i18n.js?v=20260909.2"></script>'
I18N_UI_JS = '<script defer src="/assets/js/i18n-ui.js?v=20260909.3"></script>'
I18N_CONTENT_JS = '<script defer src="/assets/js/i18n-content.js?v=20260909.2"></script>'
