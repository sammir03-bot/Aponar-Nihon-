...
export const FEATURE_REGISTRY: Feature[] = [
  ...
  { id: 'grammar', title: 'Grammar', subtitle: 'সহজ বাংলা explanation সহ grammar', icon: '文', category: 'learn', webPath: 'n5-grammar.html' },
  { id: 'reading', title: 'Reading', subtitle: 'Japanese reading practice', icon: '📖', category: 'learn', webPath: 'N5-Reading-part1.html' },
  { id: 'mock-test', title: 'Mock Test', subtitle: 'JLPT-style mock ও quiz', icon: '✅', category: 'exam', webPath: 'mock-test.html' },
  ...
  { id: 'interview', title: 'Interview Preparation', subtitle: 'Japanese job interview practice', icon: '💬', category: 'career', webPath: 'interview.html' },
  ...
  { id: 'visa', title: 'Visa Guide', subtitle: 'Japan visa ও residence information', icon: '🛂', category: 'life', webPath: 'japan-student-visa.html' },
  { id: 'arrival', title: 'Arrival Guide', subtitle: 'জাপানে আসার পর প্রথম প্রয়োজনীয় কাজ', icon: '🧳', category: 'life', webPath: 'japan-arrival-guide.html' },
  ...
  { id: 'train', title: 'Train & Transport', subtitle: 'জাপানের train ও transport guide', icon: '🚆', category: 'life', webPath: 'japan-train-platform-guide.html' },
  { id: 'emergency', title: 'Emergency Guide', subtitle: 'জরুরি সময়ে প্রয়োজনীয় official information', icon: '🆘', category: 'life', webPath: 'japan-emergency-guide.html' },
  { id: 'japan-map', title: 'Japan Map & Places', subtitle: 'Prefecture ও প্রয়োজনীয় জায়গার guide', icon: '🗾', category: 'life', webPath: 'japan-google-maps-guide.html' },
  { id: 'study-japan', title: 'Study in Japan', subtitle: 'Student life ও study guide', icon: '🎓', category: 'life', webPath: 'study-in-japan.html' },
  { id: 'cost', title: 'Living Cost', subtitle: 'Japan living cost information', icon: '💴', category: 'life', webPath: 'cost-of-studying-in-japan.html' },
  { id: 'remittance', title: 'Remittance Guide', subtitle: 'টাকা পাঠানো ও financial basics', icon: '💱', category: 'life', webPath: 'jpy-bdt-remittance.html' },
